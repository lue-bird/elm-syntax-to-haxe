...
interface state =
    case state of
                            ...
                            Ok elmJson ->
                                case elmJson of
                                    ...
                                    Elm.Project.Package _ ->
                                        ElmJsonReadFailed
                                            "You're in a package but elm-to-haxe only works for applications."
                    )
        ...
        Finished result ->
            case result of
                Err error ->
                    errorInterface "Failed to write the bundled code into src/Elm.hx."

                Ok () ->
                    Node.standardOutWrite
                        "Successfully wrote the bundled code into src/Elm.hx.\n"
